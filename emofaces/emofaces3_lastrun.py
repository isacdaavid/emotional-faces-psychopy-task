...
expName = 'emofaces3'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='G:\\emofaces\\emofaces3_lastrun.py',
...
for thisTrial_10 in trials_10:
    ...
    if key_resp_6.keys in ['', [], None]:  # No response was made
        key_resp_6.keys=None
    trials_10.addData('key_resp_6.keys',key_resp_6.keys)
    if key_resp_6.keys != None:  # we had a response
        trials_10.addData('key_resp_6.rt', key_resp_6.rt)
    thisExp.nextEntry()
