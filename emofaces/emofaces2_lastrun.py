...
expName = 'emofaces2'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='G:\\emofaces\\emofaces2_lastrun.py',
...
polygon_3 = visual.ShapeStim(
    ...
    vertices=[[-(0.05, 0.05)[0]/2.0,-(0.05, 0.05)[1]/2.0], [+(0.05, 0.05)[0]/2.0,-(0.05, 0.05)[1]/2.0], [0,(0.05, 0.05)[1]/2.0]],
    ori=0, pos=(0, 0),
...
for thisTrial_10 in trials_10:
    ...
    if key_resp_4.keys in ['', [], None]:  # No response was made
        key_resp_4.keys=None
    trials_10.addData('key_resp_4.keys',key_resp_4.keys)
    if key_resp_4.keys != None:  # we had a response
        trials_10.addData('key_resp_4.rt', key_resp_4.rt)
    thisExp.nextEntry()
...
for thisTrial_11 in trials_11:
    ...
    if key_resp_6.keys in ['', [], None]:  # No response was made
        key_resp_6.keys=None
    trials_11.addData('key_resp_6.keys',key_resp_6.keys)
    if key_resp_6.keys != None:  # we had a response
        trials_11.addData('key_resp_6.rt', key_resp_6.rt)
    thisExp.nextEntry()
