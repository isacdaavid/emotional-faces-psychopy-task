...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='F:\\emofaces\\emofaces1_lastrun.py',
...
if blank_loop.trialList in ([], [None], None):
    params = []
else:
    params = blank_loop.trialList[0].keys()
# save data for this loop
blank_loop.saveAsText(filename + 'blank_loop.csv', delim=',',
    stimOut=params,
...
# get names of stimulus parameters
if scrambled_loop.trialList in ([], [None], None):
    params = []
else:
    params = scrambled_loop.trialList[0].keys()
# save data for this loop
scrambled_loop.saveAsText(filename + 'scrambled_loop.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
# get names of stimulus parameters
if happy_loop.trialList in ([], [None], None):
    params = []
else:
    params = happy_loop.trialList[0].keys()
# save data for this loop
happy_loop.saveAsText(filename + 'happy_loop.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
# get names of stimulus parameters
if sad_loop.trialList in ([], [None], None):
    params = []
else:
    params = sad_loop.trialList[0].keys()
# save data for this loop
sad_loop.saveAsText(filename + 'sad_loop.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
# get names of stimulus parameters
if angry_loop.trialList in ([], [None], None):
    params = []
else:
    params = angry_loop.trialList[0].keys()
# save data for this loop
angry_loop.saveAsText(filename + 'angry_loop.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
# get names of stimulus parameters
if neutral_loop.trialList in ([], [None], None):
    params = []
else:
    params = neutral_loop.trialList[0].keys()
# save data for this loop
neutral_loop.saveAsText(filename + 'neutral_loop.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
# get names of stimulus parameters
if happy_loop2.trialList in ([], [None], None):
    params = []
else:
    params = happy_loop2.trialList[0].keys()
# save data for this loop
happy_loop2.saveAsText(filename + 'happy_loop2.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
# get names of stimulus parameters
if sad_loop2.trialList in ([], [None], None):
    params = []
else:
    params = sad_loop2.trialList[0].keys()
# save data for this loop
sad_loop2.saveAsText(filename + 'sad_loop2.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
# get names of stimulus parameters
if angry_loop2.trialList in ([], [None], None):
    params = []
else:
    params = angry_loop2.trialList[0].keys()
# save data for this loop
angry_loop2.saveAsText(filename + 'angry_loop2.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
# get names of stimulus parameters
if netral_2.trialList in ([], [None], None):
    params = []
else:
    params = netral_2.trialList[0].keys()
# save data for this loop
netral_2.saveAsText(filename + 'netral_2.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
# get names of stimulus parameters
if scrambled_loop2.trialList in ([], [None], None):
    params = []
else:
    params = scrambled_loop2.trialList[0].keys()
# save data for this loop
scrambled_loop2.saveAsText(filename + 'scrambled_loop2.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
# get names of stimulus parameters
if blank_loop2.trialList in ([], [None], None):
    params = []
else:
    params = blank_loop2.trialList[0].keys()
# save data for this loop
blank_loop2.saveAsText(filename + 'blank_loop2.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
