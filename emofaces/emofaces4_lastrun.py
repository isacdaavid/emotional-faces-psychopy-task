...
expName = 'emofaces4'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='G:\\emofaces\\emofaces4_lastrun.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='Presiona un botón cada vez que notes un cambio en la imagen, utilizandolos 2 botones de forma alternada:\n\nizq, der, izq, ...',
    font='Arial',
    pos=(0, 0), height=0.08, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
for thisTrial_7 in trials_7:
    ...
    if key_resp_2.keys in ['', [], None]:  # No response was made
        key_resp_2.keys=None
    trials_7.addData('key_resp_2.keys',key_resp_2.keys)
    if key_resp_2.keys != None:  # we had a response
        trials_7.addData('key_resp_2.rt', key_resp_2.rt)
    thisExp.nextEntry()
...
for thisTrial_9 in trials_9:
    ...
    if key_resp_4.keys in ['', [], None]:  # No response was made
        key_resp_4.keys=None
    trials_9.addData('key_resp_4.keys',key_resp_4.keys)
    if key_resp_4.keys != None:  # we had a response
        trials_9.addData('key_resp_4.rt', key_resp_4.rt)
    thisExp.nextEntry()
...
for thisTrial_10 in trials_10:
    ...
    if key_resp_7.keys in ['', [], None]:  # No response was made
        key_resp_7.keys=None
    trials_10.addData('key_resp_7.keys',key_resp_7.keys)
    if key_resp_7.keys != None:  # we had a response
        trials_10.addData('key_resp_7.rt', key_resp_7.rt)
    thisExp.nextEntry()
...
for thisTrial_11 in trials_11:
    ...
    if key_resp_3.keys in ['', [], None]:  # No response was made
        key_resp_3.keys=None
    trials_11.addData('key_resp_3.keys',key_resp_3.keys)
    if key_resp_3.keys != None:  # we had a response
        trials_11.addData('key_resp_3.rt', key_resp_3.rt)
    thisExp.nextEntry()
...
for thisTrial_12 in trials_12:
    ...
    if key_resp_6.keys in ['', [], None]:  # No response was made
        key_resp_6.keys=None
    trials_12.addData('key_resp_6.keys',key_resp_6.keys)
    if key_resp_6.keys != None:  # we had a response
        trials_12.addData('key_resp_6.rt', key_resp_6.rt)
    thisExp.nextEntry()
